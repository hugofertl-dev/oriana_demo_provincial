...
TEST_CMD="node test/reclamos.test.js && node test/tabbar.test.js && node test/eventos-fotos.test.js && node test/speakable.test.js && node test/estabilidad-fase1.test.js && node test/estabilidad-fase2.test.js && node test/estabilidad-fase3.test.js && node test/estabilidad-fase4.test.js && node test/estabilidad-fase5.test.js && node test/dictado-doble-envio.test.js && node test/ratelimit.test.js && node test/telemetria-log.test.js && node test/reintento-chat.test.js && node test/fase3-compat.test.js && node test/chip-durante-dictado.test.js && node test/audios-fijos.test.js && node test/fechas-dinamicas.test.js"  # tests jsdom + serverless (requiere: npm install)
BUILD_CMD=""                              # sin paso de build (sitio estático)
SRC_DIRS="index.html oriana-mobile.html api netlify oriana-proxy.py"
